...
import domain.qiita.user.contribution.{DeprecatedQiitaUserContributionHistoryRepository, DeprecatedQiitaUserInternalApiGateway, QiitaUserContributionRepository}
