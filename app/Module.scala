...
import domain.qiita.article.contribution.HatenaGateway
...
import infrastructure.qiita.article.json.{HttpHatenaGateway, ScalikejdbcQiitaRawArticleJsonRepository}
